...
Worlds
There are three main color worlds:
Blue: default starting world.
White: brighter road/world, with random night phases where visibility drops and only headlights cut through.
Purple: darker cosmic-style world.
...
Failure / Protection
Hitting a normal obstacle ends the run unless the saint ring is active. The saint ring absorbs one obstacle hit and then breaks. In dream highway mode, hitting a UFO ends the game.
